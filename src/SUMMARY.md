...
# Case File Design
- [Overview](casefiles/overview.md)
- [The `case.yaml` Manifest](casefiles/casefile_manifest.md)
- [The `herocert` Spec](casefiles/herocert_spec.md)
- [Scoring Rules](casefiles/scoring_rules.md)

---

# Lead Design
- [The `lead.yaml` Manifest](leads/lead_manifest.md)
- [Defining the Solution (`solution`)](leads/solution.md)
